...
define ('DB_HOST', 'db57b.pair.com'); // hostname of database server
define ('DB_DATABASE', 'at_main1'); // database name
define ('DB_USER', 'at_w'); // username for database connection
define ('DB_PASSWORD', 'wzPq8AtV4321'); // password for database connection
...
define ('TBL_PREFIX', 'bugs_phpbt_');	// the prefix for all tables, leave empty to use the old style
