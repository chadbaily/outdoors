...
$cfg['piece']  = isset($_GET['piece'])  ? $_GET['piece'] : "";
$cfg['response_type'] = isset($_GET['response_type']) ? $_GET['response_type'] : "html";
...
# ------------------------------------------------------------------------------
# PAYPAL CONFIG.  Uncomment the sandbox URL if you're going to test PayPal
# ------------------------------------------------------------------------------
$cfg['paypal_url'] = 'www.sandbox.paypal.com';
#$cfg['paypal_url'] = 'www.paypal.com';
