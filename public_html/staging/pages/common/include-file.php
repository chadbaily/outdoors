...
if ($cfg['action']) {
    ...
    if (isset($cfg['actions'][$cfg['action']])) {
        # If the part is implemented in the action's subdirectory, include
        # the file
        if (file_exists("$cfg[page_path]/$cfg[action]/$cfg[piece].php")) {
            include_once("$cfg[page_path]/$cfg[action]/$cfg[piece].php");
        }
        # If the action is implemented directly in the page's subdirectiory,
        # include the file
        elseif (file_exists("$cfg[page_path]/$cfg[action].php")) {
